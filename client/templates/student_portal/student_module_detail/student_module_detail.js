...
Template.student_portal_student_module_detail.helpers({
    // This student's name
...
Template.student_portal_student_module_detail.onCreated(function() {
    ...
    var token = Session.get("studentPortalToken");
    ...
    if (typeof(token) === 'undefined') {
        ...
        Meteor.call('studentPortal_GetStudentsAttendanceForModule', this.data.studentNumber, this.data.moduleID, token, function(err, jsonResponse) {
            if(err) {
